          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {(['maintenance_exec', 'super_admin', 'finance'].includes(userProfile?.role)) && (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Scrap</h3>
              </Link>
            )}

            {/* Outsource Invoices */}
            {(['maintenance_exec', 'super_admin', 'finance', 'supervisor'].includes(userProfile?.role)) && (
              <Link
                to="/outsource-invoices"
                className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow flex flex-col items-center text-center group"
              >
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Outsource Invoices</h3>
              </Link>
            )}
